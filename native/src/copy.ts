...
export interface AppCopy {
  ...
  readonly requestMaterialPreview: string
...
const english: AppCopy = {
  ...
  requestMaterialPreview: 'What Harness will receive',
...
const simplifiedChinese: AppCopy = {
  ...
  contextLabel: '已捕获上下文',
  contextDescription: '这里只展示随选区一起捕获的上下文。默认只发送固定选区；预览内容不会自动加入请求，只有经过明确授权后才会加入。',
  ...
  requestMaterialPreview: 'Harness 将收到的材料',
  askLabel: '针对当前选区提问',
  askPlaceholder: '输入追问',
  explain: '解释',
  ask: '提问',
